...
class SelectMaker extends StatefulWidget {
  final Map<String, dynamic> selectedMaker;
  ...
  const SelectMaker({
    super.key,
    required this.updateSelectedMaker,
              ...
              child: Row(
                children: [
                  ...
                  CategoryTitle(
                    ...
                    isSelected: false,
                    showModal: widget.showModal,
                    modalIndex: selectedMakerId != null ? 2 : null,
                  ),
                  CategoryTitle(
                    title: '연료',
                    isSelected: false,
          ...
          child: Padding(
            ...
            child: SizedBox(
              ...
              child: Wrap(
                ...
                children: widget.carInfo.asMap().entries.map<MakerItem>(
                  (MapEntry<int, dynamic> makerList) {
                    ...
                    return MakerItem(
                      ...
                      isSelected: selectedMakerId == index ? true : false,
                      makerId: index,
