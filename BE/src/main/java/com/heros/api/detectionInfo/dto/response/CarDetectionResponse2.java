...
@Data
@NoArgsConstructor
public class CarDetectionResponse2 {
    ...
    private Map<String, List<DetectionInfo>> initialDetectionInfos;
    @Schema(description = "반납 파손 정보 리스트", example = "[detectionInfo]")
    private Map<String, List<DetectionInfo>> latterDetectionInfos;

    public CarDetectionResponse2(Car car, Map<String, List<DetectionInfo>> initialDetectionInfos, Map<String, List<DetectionInfo>> latterDetectionInfos) {
